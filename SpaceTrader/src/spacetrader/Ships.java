...
public class Ships {
    ...
    //    public Ship(String name, int price, int MLP, int weight, int attack, int speed, int fuelCapacity, int health){
        Ship tankShipOne = new Ship("Titan 1", 1000, 2, 70, 5, 4, 600, 100);
        list.add(tankShipOne);
        
        Ship tankShipTwo = new Ship("Titan 2", 2000, 5, 85, 7, 4, 750, 125);
        list.add(tankShipTwo);

        Ship tankShipThree = new Ship("Titan 3", 5000, 100, 10, 10, 5, 1000, 150);
        ...
        Ship speedShipThree = new Ship("Banshee 3", 5000, 10, 5, 5, 10, 1000, 60);
