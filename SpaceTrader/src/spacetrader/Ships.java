...
public class Ships {
    ...
    //    public Ship(String name, int price, int MLP, int weight, int attack,
        // int speed, int fuelCapacity, int health){
        ...
        Ship tankShipThree = new Ship("Titan 3", 5000, 100, 10, 10, 5, 999, 150,
                50);
        list.add(tankShipThree);



        Ship speedShipOne = new Ship("Banshee 1", 1000, 2, 25, 5, 5, 600, 40,
                10);
        list.add(speedShipOne);

        Ship speedShipTwo = new Ship("Banshee 2", 2000, 5, 15, 5, 7, 750, 50,
                20);
        list.add(speedShipTwo);

        Ship speedShipThree = new Ship("Banshee 3", 5000, 10, 5, 5, 10, 999, 60,
                30);
        ...
        Ship tradeShipOne = new Ship("Serenity 1", 1000, 0, 70, 5, 3, 600, 60,
                100);
        list.add(tradeShipOne);

        Ship tradeShipTwo = new Ship("Serenity 2", 2000, 0, 75, 5, 2, 700, 70,
                200);
 ...
 * @return list Array list of all ships.
 */
    public static ArrayList<Ship> getList() {
        return list;
    }
/**
 * Gets the ship. Ship is found by name.
 * @param name
 * @return an element of the ship list
 */
