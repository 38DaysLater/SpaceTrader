...
public class Ships {
    ...
    //    public Ship(String name, int price, int MLP, int weight, int attack, int speed, int fuelCapacity, int health){
        ...
        Ship tankShipThree = new Ship("Titan 3", 5000, 10, 10, 10, 5, 999, 150, 50);
        ...
        Ship normalShipOne = new Ship("Ghost 1", 1000, 0, 50, 3, 4, 500, 70, 20);
        list.add(normalShipOne);
        
        Ship normalShipTwo = new Ship("Ghost 2", 2000, 0, 30, 4, 5, 700, 80, 40);
