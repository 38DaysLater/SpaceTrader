 ...
 */
    public Market(int techLevel, int resourceLevel, Planet planet) {
        ...
        inventory.setCapacity(100000000); //marketplace can hold 
                                            //whatever it wants
        ...
        for (Item item: Items.getList()) {
            if (techLevel >= item.getMTLP()) {
                ...
                //keeping track of the final prices of itme to be placed 
                //in inventory
...
//        System.out.println();
    ...
    public String sellItem(String itemName, Character player,
        ...
        } else if (price * (int) quantityWanted > playerInventory
                .getBalance()) {
            //System.out.println("Insufficient sales by player");
            return "Insufficient sales by player";
        } else if (playerInventory.totalItemCount() + (int) quantityWanted
